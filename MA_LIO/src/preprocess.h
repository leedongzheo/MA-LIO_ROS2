...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void process(const std::shared_ptr<const livox_ros_driver2::msg::CustomMsg> &msg, PointCloudXYZI::Ptr &pcl_out, int lidar);
  ...
  private:
  void avia_handler(const std::shared_ptr<const livox_ros_driver2::msg::CustomMsg> &msg, int lidar);
