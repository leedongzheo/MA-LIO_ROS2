...
void Preprocess::process(const std::shared_ptr<const livox_ros_driver2::msg::CustomMsg> &msg, PointCloudXYZI::Ptr &pcl_out, int lidar)
{
  avia_handler(msg, lidar);
  *pcl_out = pl_surf;
}

void Preprocess::process(const sensor_msgs::msg::PointCloud2::ConstSharedPtr &msg, PointCloudXYZI::Ptr &pcl_out, int lidar)
{
...
void Preprocess::avia_handler(const std::shared_ptr<const livox_ros_driver2::msg::CustomMsg> &msg, int lidar)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::oust64_handler(const sensor_msgs::msg::PointCloud2::ConstSharedPtr &msg, int lidar)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::velodyne_handler(const sensor_msgs::msg::PointCloud2::ConstSharedPtr &msg, int lidar)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
